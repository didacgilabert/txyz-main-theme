 ...
 * Slug: txyz-2025-main-theme/template-home-text-blog
...
<main class="wp-block-group" style="margin-top:var(--wp--preset--spacing--60)">
	...
	<h1 class="wp-block-heading alignwide has-x-large-font-size"><?php esc_html_e( 'Blog', 'txyz-2025-main-theme' ); ?></h1>
	<!-- /wp:heading -->
