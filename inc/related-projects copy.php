...
<h2 class="wp-block-heading has-large-font-size highly-related">
    ...
    <span class="main-title"><?php echo get_secondary_title(6288); // Are you geek?? ?></span>
</h2>
...
<?php if (has_term('nucli', 'project')) : // Nucli Schools ?>
    <h4 class="line-break has-medium-font-size related-project workshops"><a href="<?php echo esc_url(get_permalink(17504)); ?>"><span class="main-title"><?php echo get_the_title(17504); ?></span></a></h4>
<?php endif; ?>

<?php if (has_term('share-that-file', 'project')) : // Share That File ?>
    <h4 class="line-break has-medium-font-size related-project workshops"><a href="<?php echo esc_url(get_permalink(8066)); ?>"><span class="main-title"><?php echo get_the_title(8066); ?></span></a></h4>
<?php endif; ?>
...
<?php if (has_term('single', 'project')) : // Single ?>
    <h4 class="line-break has-medium-font-size related-project workshops"><a href="<?php echo esc_url(get_permalink(10631)); ?>"><span class="main-title"><?php echo get_the_title(10631); ?></span></a></h4>
<?php endif; ?>

<?php if (has_term('sol', 'project')) : // Sòl ?>
    <h4 class="line-break has-medium-font-size related-project workshops"><a href="<?php echo esc_url(get_permalink(246)); ?>"><span class="main-title"><?php echo get_the_title(246); ?></span></a></h4>
<?php endif; ?>
